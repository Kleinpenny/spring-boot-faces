/*! modernizr 3.5.0 (Custom Build) | MIT *//自动检测当前浏览器是否支持CSS或者HTML5的功能，并且在编写程序的时候还可以给判定条件，比如如果支持的话做什么，不支持的话做另外的什么 no-前缀https://www.cnblogs.com/JoannaQ/p/3281841.html
